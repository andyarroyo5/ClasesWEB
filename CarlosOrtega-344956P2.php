  ...
  <body>
    ...
    <div class="">
      <form  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="POST">
        ...
        <span>Cantidad de pesos mexicanos</span>
        <input placeholder="Ingresa una cantidad" type="number" name="cantidad" value="" required="true">
        ...
        <select name="tipoMoneda">
          ...
          <option value="FRF">Francos suizos</option>
        </select>

        <!-- //Importante type-submit -->
        <button type="submit" class="btn btn-secondary">Convertir</button>
        <!-- <button type="button" name="convertir">Convertir</button> -->
